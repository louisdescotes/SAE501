      ...
      <div className="seven grid-p columns">
        <div className="seven-header">
          ...
          <p className="type-18 seven-header-text">
            ...
            de petits détails sont négligés. Les interactions, les transitions,
            la cohérence des éléments : chacun influence l’expérience. Un détail
            manqué peut transformer un site “wow” en une expérience frustrante.
          </p>
        </div>
      </div>
    </section>
